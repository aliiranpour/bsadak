                      ...
                      >
                        {route.subRoutes.map((subRoute, subIndex) => (
                          <Link
                            ...
                            fontWeight="bold"
                            fontFamily="yekan"
                            color={activeRoute(subRoute.path.toLowerCase()) ? activeColor : inactiveColor}
                            onClick={(e) => e.stopPropagation()}
                          >
                            <HStack spacing="26px" py="10px" ps="20px" my={5} ms={5}>
                              <Text
                                me="auto"
                                color={activeRoute(subRoute.path.toLowerCase()) ? activeColor : inactiveColor}
                                fontWeight={activeRoute(subRoute.path.toLowerCase()) ? "bold" : "normal"} 
                              >
                                {subRoute.name}
                              </Text>
                            </HStack>
                      ...
                      >
                        {route.subRoutes.map((subRoute, subIndex) => (
                          <Link
                            ...
                            onClick={(e) => e.stopPropagation()}
                          >
                            <HStack spacing="26px" py="10px" ps="10px" ms={10} mt={3}>
                              <Text
                                me="auto"
                                color={activeRoute(subRoute.path.toLowerCase()) ? activeColor : inactiveColor}
                                fontWeight={activeRoute(subRoute.path.toLowerCase()) ? "bold" : "normal"}
